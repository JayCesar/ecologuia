...
class __Mustache_2cea05c1e60b498e8cc546585ab60e61 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block9bd3dedeafdb7048e237432a32aa7004'),
            ));
...
';
    ...
    public function block9bd3dedeafdb7048e237432a32aa7004($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
