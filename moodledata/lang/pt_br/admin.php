...
/**
 * Strings for component 'admin', language 'pt_br', version '3.6'.
 *
 * @package     admin
 * @category    string
...
$string['configenablesafebrowserintegration'] = 'Isto adiciona a opção "Exigir navegador Safe Exam" ao campo "Segurança do navegador" no formulário de configuração do questionário. Para mais informações, veja http://www.safeexambrowser.org';
...
$string['configusesitenameforsitepages'] = 'Se ativado, o nome breve do site será usado para as páginas do site na barra de navegação ao invés da string \'Páginas do site\' .';
...
$string['creatornewroleid_help'] = 'Se o usuário ainda não tiver permissão para gerenciar o novo curso, ele será automaticamente inscrito usando esse papel.';
$string['cron'] = 'Cron';
...
$string['loginpasswordautocomplete_help'] = 'Se ativado, os usuários não têm permissão para salvar a senha da conta no seu navegador.';
