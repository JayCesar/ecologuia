...
/**
 * Strings for component 'attendance', language 'pt_br', version '3.6'.
 *
 * @package     attendance
 * @category    string
...
$string['sessionduplicate'] = 'Existe uma sessão duplicada para o curso: {$a->course} na frequência: {$a->activity}';
