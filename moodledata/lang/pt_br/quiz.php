...
/**
 * Strings for component 'quiz', language 'pt_br', version '3.6'.
 *
 * @package     quiz
 * @category    string
...
$string['quiz:emailconfirmsubmission'] = 'Receber mensagem de confirmação ao enviar';
$string['quiz:emailnotifysubmission'] = 'Receber mensagem de notificação quando uma tentativa é submetida';
