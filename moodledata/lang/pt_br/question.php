...
/**
 * Strings for component 'question', language 'pt_br', version '3.6'.
 *
 * @package     question
 * @category    string
...
$string['privacy:metadata:link:qbehaviour'] = 'O Subsistema de Questões usa o plugin de Comportamento da Questão.';
$string['privacy:metadata:link:qformat'] = 'O Subsistema de Questões usa o plugin de Comportamento da Questão, com o propósito de importar e exportar questões em diferentes formatos.';
$string['privacy:metadata:link:qtype'] = 'O Subsistema de Questões interage com o plugin de Tipos de Questão que contém diversos tipos de questão.';
