...
/**
 * Strings for component 'tool_xmldb', language 'pt_br', version '3.6'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['confirmcheckbigints'] = 'Essa funcionalidade irá procurar <a href="http://tracker.moodle.org/browse/MDL-11038"> possíveis erros em campos inteiros</a>no seu servidor Moodle, gerando (mas não executando!) automaticamente as instruções SQL necessárias para corrigir esses possíveis erros.<br /><br />
...
É altamente recomendado utilizar a versão mais recente (+ versão) disponível do Moodle (1.8, 1.9, 2.x ...) antes de executar a busca por erros.<br /><br />
Essa funcionalidade pode ser executada com segurança a qualquer momento, porque acessa o BD apenas como leitura.';
