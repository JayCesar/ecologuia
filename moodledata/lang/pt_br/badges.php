...
/**
 * Strings for component 'badges', language 'pt_br', version '3.6'.
 *
 * @package     badges
 * @category    string
...
$string['error:invalidbadgeurl'] = 'Formato de URL do emissor inválido. O URL deve ter um prefixo http:// ou https://.';
