...
/**
 * Strings for component 'moodle', language 'pt_br', version '3.6'.
 *
 * @package     moodle
 * @category    string
...
$string['cookiesenabledonlysession_help'] = 'Este site usa um cookie de sessão, geralmente chamado de MoodleSession. Você deve permitir que este cookie em seu navegador forneça continuidade e permaneça conectado ao navegar no site. Quando você sai ou fecha o navegador, esse cookie é destruído (no seu navegador e no servidor).';
...
$string['coursecategory_help'] = 'Essa configuração determina a categoria na qual o curso aparecerá na lista de cursos.';
...
$string['coursedisplay_multi'] = 'Mostrar uma seção por página';
$string['coursedisplay_single'] = 'Mostrar todos os tópicos em uma página';
$string['courseduration'] = 'Duração do curso';
$string['courseduration_desc'] = 'A duração do curso é usada para calcular a data de término padrão do curso. A data de término do curso é usada para determinar se um curso deve ser incluído na lista de cursos de um usuário.  Ele também pode ser usado por relatórios personalizados. Os usuários ainda podem entrar no curso após a data de término.';
...
* Incluir uma nova anotação - para adicionar uma anotação a um participante selecionado';
