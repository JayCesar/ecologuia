...
/**
 * Strings for component 'assign', language 'pt_br', version '3.6'.
 *
 * @package     assign
 * @category    string
...
* Automaticamente até ser aprovado - O envio do estudante é automaticamente reaberto até o estudante obter a nota para ser aprovado, definido no livro de notas para esta tarefa.';
...
$string['gradedfollowupsubmit'] = 'Avaliado - envio recebido posteriormente';
...
$string['privacy:blindmarkingidentifier'] = 'O identificador usado para avaliação cega';
