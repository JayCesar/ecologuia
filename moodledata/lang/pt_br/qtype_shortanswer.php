...
/**
 * Strings for component 'qtype_shortanswer', language 'pt_br', version '3.6'.
 *
...
$string['privacy:metadata'] = 'O plugin de tipo de questão Resposta curta não armazena nenhum dado pessoal.';
