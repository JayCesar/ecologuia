...
/**
 * Strings for component 'auth_email', language 'pt_br', version '3.6'.
 *
 * @package     auth_email
 * @category    string
...
$string['auth_emaildescription'] = '<p>O auto-cadastro por e-mail permite a um usuário criar sua própria conta pelo botão \'Criar nova conta\' na página de login. O usuário em seguida recebe um e-mail contendo um link seguro para uma página onde ele pode confirmar sua conta. Nos próximos acessos o nome de usuário e senha serão validados em relação os valores armazenados no banco de dados do Moodle.</p><p>Observação: Além de habilitar o plugin auto-cadastro por e-mail, a opção de auto-cadastro também deve estar habilitada no menu suspenso da página \'Gerenciar autenticação\'.</p>';
