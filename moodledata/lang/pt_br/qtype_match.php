...
/**
 * Strings for component 'qtype_match', language 'pt_br', version '3.6'.
 *
 * @package     qtype_match
 * @category    string
...
$string['shuffle_help'] = 'Se habilitada, a ordem das instruções (respostas) é embaralhada aleatoriamente para cada tentativa, quando a opção "Embaralhar entre questões" estiver habilitada nas configurações da atividade.';
