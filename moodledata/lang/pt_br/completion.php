...
/**
 * Strings for component 'completion', language 'pt_br', version '3.6'.
 *
 * @package     completion
 * @category    string
...
Se for mostrada uma caixa com borda sólida, você pode clicar nela para marcar quando achar que já concluiu a atividade. (Se mudar de ideia é só clicar novamente).';
...
$string['roleaggregation_all'] = 'Todos os papéis selecionados para marcar quando a condição for atendida';
