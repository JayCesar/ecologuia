...
/**
 * Strings for component 'qtype_multichoice', language 'pt_br', version '3.6'.
 *
...
$string['privacy:metadata'] = 'O plugin tipo de questão Múltipla escolha não armazena dados pessoais.';
