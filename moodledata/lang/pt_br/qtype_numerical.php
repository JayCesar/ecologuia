...
/**
 * Strings for component 'qtype_numerical', language 'pt_br', version '3.6'.
 *
...
$string['privacy:metadata'] = 'O plugin tipo de questão Númerica não armazena nenhum dado pessoal.';
